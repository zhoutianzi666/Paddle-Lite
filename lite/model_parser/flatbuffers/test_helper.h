...
inline lite::model_parser::Buffer GenerateProgramCache() {
  ...
  var_a2.SetType(paddle::lite::VarDataType::DENSE_TENSOR);
  var_a2.SetName("var_a2");
  var_a2.SetShape({2, 2, 1});

  VarDesc var_a0(block_a.AddVar<proto::VarDescT>());
  var_a0.SetType(paddle::lite::VarDataType::DENSE_TENSOR);
  ...
  var_b0.SetType(paddle::lite::VarDataType::DENSE_TENSOR);
